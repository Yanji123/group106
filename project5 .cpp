...
}//生成Merkle Tree，倘若该层节点不足以两两分完，则将最后一个节点记录下来，
 //并以它为头节点对应的树上的所有节点高度均加一作为下一层节点进行，以符合RFC6962要求。
...
int main()
{
	...
	char message[] = "Hi!This is Yanji123.I'm writing a merkle tree!";
